      ...
      <div className="space py-6 ">
        ...
        <div className="flex  md:justify-end  ">
          <div className=" md:w-[35%] ">
            ...
            www.brokenbycoker.com is committed to protecting your privacy and maintaining the security of any personal information received from you. We strictly adhere to the requirements of the data protection legislation in Nigeria. The purpose of this statement is to explain to you what personal information we collect and how we may use it.
...
We create art through fashion, experiences and imagery inspired by Africa’s evolving identity. Lagos based..
</p>

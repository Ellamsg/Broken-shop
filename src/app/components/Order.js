    ...
    <div className="space">
      ...
      <div className="text-center w-full border-collapse py-2">
        <div className="flex my-3 md:my-6 pb-3 border-b-2 border-white justify-between">
            ...
            <div><p>product</p></div>
            <div className="opacity-0"><p>paid</p></div>
            <div><p>  Qty</p></div>
            <div><p>status</p></div>
        ...
        <div>
          {orders.map((product) => (
            <div className="flex pt-2 md:text-[16px] text-[10px] py-3 justify-between" key={product._id}>
            
              
              <div className="">
              <img className="md:size-[200px] size-[90px]" src={product.image}/>
              <p className="pt-2 ">{product.name}</p>
                </div>
          
              <div>{
              
              product.paid?<p className="text-green">paid</p>:<p className="text-red">not paid</p>
